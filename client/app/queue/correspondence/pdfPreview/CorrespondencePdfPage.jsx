...
import {
  ...
  PAGE_MARGIN } from '../../../reader/constants';
...
export const CorrespondencePdfPage = ({...props}) => {

  let isDrawing = false;
  let renderTask = null;
  let marks = [];
  let measureTimeStartMs = null;
  ...
  render() {
    ...
    const { outerDivWidth, outerDivHeight } = this.getDivDimensions();
